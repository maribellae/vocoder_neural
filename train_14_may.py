...
def check(model3, device, data_len ,data, iter_meter):
    for i in range(data_len):
        ...
        torch.save(mel_out, "/home/common/dorohin.sv/makarova/FastSpeech2/vocoder_neural/mels/mels_from_11may2_{}.pt".format(i))
            
        torch.save(mel_cut, "/home/common/dorohin.sv/makarova/FastSpeech2/vocoder_neural/mels/mels_from_ref_11may2_{}.pt".format(i))
...
#check(model3, device, 1 ,datas, iter_meter)
...
for epoch in range(1, epochs + 1):
      ...
      print("Epoch  ",  epoch , "MEAN LOSS IS  " , full_loss/np.shape(datas)[0])
      ...
      if ((epoch  == 1)or(epoch  == 25)or(epoch == 50)): 
         #  with open("/home/common/dorohin.sv/makarova/FastSpeech2/vocoder_neural/metrics/metrics_right_27april_withoutconvs_{}.txt".format(epoch), "w") as output:
          #      output.write(str(losses))
           torch.save(model3.state_dict(), "/home/common/dorohin.sv/makarova/FastSpeech2/vocoder_neural/weights/weights_14_may_{}".format(epoch))
