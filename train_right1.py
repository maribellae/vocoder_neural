    ...
    for i in r:
     ...
     #   print(length , "LENGTH")
      ...
      #  print(energy_out.requires_grad)
       ...
       # print ("FROM MODEL p", mel_out.shape , pitch_out.shape,  energy_out.shape)
        #print ("FROM Ref p", mel_cut.shape , pitch.shape,  energy.shape)
      ...
      #  model3.myconv1.weight.retain_grad
        ...
        #     print(name, p.grad)
        #print ('eeeeee', model3.mylin3.weight.requires_grad)
        print(model3.mylin3.weight)
      #  print(loss.grad)
       
       # loss.backward(retain_graph = True)
       # print('TTTTHERE') 
       # print (model3.modelA.fc2.weight.grad)

        #print(model3.modelB.Embedding.weight.grad)
     ...
     #   model3.mylin3.weight.retain_grad()
      #  print(model3.modelB.Embedding.weight)
...
for epoch in range(1, epochs + 1):
      full_loss ,losses  = train(model3, device,2,datas, mel_pad, input_lengths, criterion, optimizer,  iter_meter)
      print("Epoch  ",  epoch , "MEAN LOSS IS  " , full_loss/2)

     # if ((epoch  == 1)or(epoch  == 15)or(epoch == 30)) :
     #      with open("/home/common/dorohin.sv/makarova/FastSpeech2/vocoder_neural/metrics/metrics_right_30_onlyfast_{}.txt".format(epoch), "w") as output:
     #           output.write(str(losses))
     #      torch.save(model3.state_dict(), "/home/common/dorohin.sv/makarova/FastSpeech2/vocoder_neural/weights/weights_right_30_onlyfast_{}".format(epoch))
